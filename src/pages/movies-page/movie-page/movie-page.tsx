...
const MoviePage = () => {
  ...
  const [isOpenModalForDeleteMovie, setOpenModalForDeleteMovie] =
    useState(false);
  ...
  const updateMovie = () => {
    setLoading(true);
    moviesAPI
      .updateMovie(movie?.id, movieModel)
      .then(({ data }) => {
        // @ts-ignore
        setMovie((prevState) => ({
          ...prevState,
  ...
  const addPostersForMovie = () => {
    ...
    moviesAPI
      .uploadPostersForMovie(movie?.id, formData)
      .then(({ data }) => {
        // @ts-ignore
        setMovie((prevState) => ({
          ...prevState,
  ...
  return (
    <Container>
      ...
      <ModalMui
        isOpen={isOpenModalForEditMovie}
        title="Edit movie"
        styles={DIALOG}
      ...
      <ModalMui
        isOpen={isOpenModalForDeleteMovie}
        title="Are you sure ?"
        styles={DIALOG}
